...
$backendCmd = "`$env:PYTHONPATH = '$PSScriptRoot;$PSScriptRoot\src'; Set-Location '$PSScriptRoot'; uv run uvicorn resolume_mcp.server:app --host 127.0.0.1 --port $BackendPort --log-level info"
