...
class ResolumeOSCClient:
    ...
    def __init__(
        self,
        host: str = '127.0.0.1',
        incoming_port: int = 7000,
        outgoing_port: int = 7001
    ):
    ...
    async def send_message(self, address: str, *args: Union[int, float, str, bytes, bool]) -> None:
...
class ResolumeConnectionManager:
    ...
    def __init__(self, host: str = '127.0.0.1', port: int = 7001):
        self.client: Optional[ResolumeOSCClient] = None
        self.host = host
        self.port = port
