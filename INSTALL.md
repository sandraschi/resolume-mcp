...
4. Start the server:
   ...
   uv run uvicorn resolume_mcp.server:app --port 10920
   ```
5. Open `http://localhost:10920` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/resolume-mcp/issues) |
