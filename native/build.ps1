...
if (Test-Path $envExample) {
    ...
    Write-Host "  Bundled .env.example check" -ForegroundColor Green
} else {
    ...
    Write-Host "  Created placeholder .env.example" -ForegroundColor Yellow
}
...
$strayExe = "$PSScriptRoot\target\release\resolume-mcp-backend.exe"
